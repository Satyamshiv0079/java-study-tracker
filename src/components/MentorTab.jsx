...
export default function MentorTab({
  ...
  return (
    <div className="max-w-4xl mx-auto bg-slate-900 border border-slate-800 rounded-xl overflow-hidden flex flex-col h-[calc(100vh-12rem)] shadow-lg transition hover:border-slate-700">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 custom-scrollbar">
        ...
        {isGenerating && (
          <div className="flex justify-start animate-fade-in">
            <div className="bg-slate-800 text-slate-400 rounded-2xl rounded-tl-sm px-4 py-3 text-sm flex items-center gap-2 border border-slate-700">
      ...
      <div className="p-4 bg-slate-950 border-t border-slate-800">
        <form onSubmit={(e) => { e.preventDefault(); handleSendMessage(); }} className="flex gap-2">
          <input
            ...
            className="flex-1 bg-slate-900 border border-slate-700 focus:border-indigo-500 rounded-lg px-4 py-2 text-sm text-white focus:outline-none transition shadow-inner"
          />
          <button
            type="submit"
