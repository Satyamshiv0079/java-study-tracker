  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-white">Mock Interview Vivas</h2>
        <p className="text-sm text-slate-400">Test your ability to articulate concepts verbally.</p>
      </div>
      ...
      {activeVivaCard ? (
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-8 min-h-[300px] flex flex-col justify-center relative transition hover:border-slate-700 shadow-lg">
          <div className="absolute top-4 left-4 text-xs font-mono text-amber-500/50">Q{currentQuizIndex + 1}</div>
          
          <h3 className="text-xl font-medium text-center text-slate-200 mb-8 leading-relaxed">
            "{activeVivaCard.q}"
          </h3>
              ...
              <div className="w-full text-center animate-fade-in">
                ...
                <div className="flex justify-center gap-3">
                  <button
                    ...
                    className="px-5 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-bold rounded-lg transition"
                  >
                    Got it wrong / Pass
                  </button>
                  <button
                    ...
                    className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold rounded-lg transition shadow-[0_0_10px_rgba(16,185,129,0.2)]"
                  >
                    Nailed it
                  </button>
                </div>
        ...
        <div className="text-center text-slate-500">No cards available for this topic.</div>
      )}
